...
-- ou
SELECT a.ds_acessorio
FROM veiculo_acessorio va RIGHT JOIN acessorio a ON (va.cd_acessorio = a.cd_acessorio)
WHERE va.nr_placa IS NULL;
...
-- ou
SELECT ma.ds_marca AS Marcas, mo.ds_modelo AS Modelos
FROM marca ma, modelo mo, veiculo v, combustivel c, veiculo_combustivel vc, acessorio a, veiculo_acessorio va
WHERE ma.cd_marca = mo.cd_marca
  ...
  AND a.ds_acessorio = 'Volante multifuncional';
